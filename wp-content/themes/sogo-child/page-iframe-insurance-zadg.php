<?php
// Template name: ZAD G & Hova - iframe
...
<!--							</div>-->
							...
							/*	if ( isset( $_GET['ins_order'] ) ) {
								...
								?>
                                <form action="<?php echo add_query_arg( array('iframe'=>'1', 'insurance-type'=>$insurance_type), get_permalink( get_field( '_sogo_insurance_compare_2_link', 'option' ) ) ); ?>"
                                      method="post"
                                      id="form-1">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="insurance-date-finish-wrapper d-none">
                                                                    ...
                                                                    <!--                                    <span>--><?php //_e( 'Insurance period', 'sogoc' ); ?><!--</span>-->
                                                                    <!---->
									...
									<?php echo isset( $order_params['insurance-date-finish'] ) ? $order_params['insurance-date-finish'] : ''; ?>"
                                        ...
                                        <div class="card">
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-lg-5 s-input-wrapper">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" id="city" name="city" class="w-100" value="<?php echo isset($_GET['ins_order']) ? $order_params['city'] : '';?>" />
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-lg-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="checkbox" name="tac-1" <?php echo isset( $_GET['ins_order'] ) ? 'checked' : ''; ?>
                                            ...
                                            <?php echo $help_array['tac-1']; ?>
                                                                    ...
                                                                    <label for="tac-1" class="d-flex align-items-center checkbox-label text-5 color-6 flex-wrap">
		...
		<div class="modal-dialog modal-dialog-centered modal-lg top-18vh" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer d-flex justify-content-between px-1 px-sm-15">
					<button type="button" data-choose="" class="s-button s-button-2 w-auto px-1 px-md-2 px-lg-4 m-0 mr-lg-1 bg-5 border-color-5 cursor-pointer btn-default must_choose"><?php _e('Change to ', 'sogoc')?><span></span></button>
					<button type="button" data-exists="" data-chosen="" class="s-button s-button-2 w-auto px-1 px-md-2 px-lg-4 m-0 ml-lg-1 bg-5 border-color-5 cursor-pointer btn-default chosen_date"><?php _e('Leave ', 'sogoc')?><span></span></button>
				</div>
			</div>
		</div>
	</div>
