<!--?php /* Template Name: page-sami-renew-hova-click*/ ?-->
<?php
...
?>
<!-- הדר -->
<div class="w-100 bg-white p-1 p-lg-3" style="position: fixed; top: 0; z-index: 9">
	<a href="https://www.hova.co.il" class="d-inline-block" title="ביטוח חובה">
...
display: none;
    ...
    <div align="center" style="padding-left: 0px;  padding-right: 0px" class="container-fluid">
        <!-- CONTENT -->
