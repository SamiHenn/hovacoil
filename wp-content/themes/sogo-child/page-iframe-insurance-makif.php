<?php
// Template name: Makif & Hova - iframe
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-lg-5 s-input-wrapper">
                                                                <div class="form-group">
                                                                    ...
                                                                    <label for="city"
                                                                           class="text-5 color-6 d-block mb-1"><?php __( 'City of residence', 'sogoc' ) ?></label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between px-1 px-sm-15">
                    <button type="button" data-choose=""
                            class="s-button s-button-2 w-auto px-1 px-md-2 px-lg-4 m-0 mr-lg-1 bg-5 border-color-5 cursor-pointer btn-default must_choose"><?php _e( 'Change to ', 'sogoc' ) ?>
                        <span></span></button>
                    <button type="button" data-exists="" data-chosen=""
                            class="s-button s-button-2 w-auto px-1 px-md-2 px-lg-4 m-0 ml-lg-1 bg-5 border-color-5 cursor-pointer btn-default chosen_date"><?php _e( 'Leave ', 'sogoc' ) ?>
                        <span></span></button>
                </div>
            </div>
        </div>
