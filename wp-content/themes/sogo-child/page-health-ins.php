<?php
/**
 * Template Name: Health Insurance
 */
                                                            ...
                                                            <b-container class="mt-3">
                                                                <b-form @submit.prevent="onStep1()"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 mb-3">
                                                                            <div class="s-radio-wrapper">
                                                                                ...
                                                                                <span class="invalid-feedback d-block mt-2">{{ errors.first('form1.Gender') }}</span>
                                                                    ...
                                                                    <div class="s-input-wrapper mb-3">
                                                                        ...
                                                                        <span class="invalid-feedback d-block mt-2">{{ errors.first('form1.Age') }}</span>
                                                                    </div>

                                                                    <b-form-group
                                                                            label="בחר את סוג הכיסוי המבוקש"
                                                                            :invalid-feedback="errors.first('form1.SelectedInsuranceTypes[]')"
                                                                            :state="!errors.has('form1.SelectedInsuranceTypes')">
                                                                        <b-form-checkbox value="83000001"
                                                                                         v-model="SelectedInsuranceTypes"
                                                                                         name="SelectedInsuranceTypes[]"
                                                                                         v-validate="'required'">ניתוחים
                                                                        </b-form-checkbox>
                                                                        <b-form-checkbox value="83000002"
                                                                                         v-model="SelectedInsuranceTypes"
                                                                                         name="SelectedInsuranceTypes[]"
                                                                                         v-validate="'required'">השתלות
                                                                        </b-form-checkbox>
                                                                        <b-form-checkbox value="83000004"
                                                                                         v-model="SelectedInsuranceTypes"
                                                                                         name="SelectedInsuranceTypes[]"
                                                                                         v-validate="'required'">תרופות
                                                                        </b-form-checkbox>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <div class="row mb-5">
                                                        <div class="col-lg-12   px-lg-2">
                                                            ...
                                                            <div v-if="list">
                                                                <div class="row  ">
                                                                    <div class="col-lg-12 px-0 px-lg-0 insurance-cube-wrapper yb-3">
                                                                        ...
                                                                        <?php echo do_shortcode('[contact-form-7 id="3371" title="טופס ביטוח בריאות"]');?>
                                                                        </div>
                                                                        <div v-for="(item, key ) in list"
                                                                            ...
                                                                            <div class="insurance-cube">
                                                                                ...
                                                                                <div :id="'collapseOne-'+key"
                                                                                    ...
                                                                                    <div class="row mb-3">
                                                                                        <div class="col-md-4 "
                                                                                             v-if="SelectedInsuranceTypes.includes('83000002')">
                                                                                            <h2 class="text-5 color-3 mb-1">
                                                                                                השתלות</h2>
                                                                                            <ul class="text-6"
                                                                                                v-for="remark in item.ImplantsBullets">
                                                                                                <li>{{ remark }}</li>
                                                                                            </ul>
                                                                                        </div>
                                                                                        <div class="col-md-4"
                                                                                             v-if="SelectedInsuranceTypes.includes('83000004')">
                                                                                            <h2 class="text-5 color-3 mb-1">
                                                                                                תרופות</h2>
                                                                                        ...
                                                                                        <div class="col-md-4"
                                                                                             v-if="SelectedInsuranceTypes.includes('83000001')">
                                                                                            <h2 class="text-5 color-3 mb-1">
                                                                                                ניתוחים</h2>
    ...
    jQuery(document).ready(function () {
        app = new Vue({
            ...
            mounted: function () {
                ...
                var endtyear = (new Date).getFullYear()
