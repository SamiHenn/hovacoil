...
// orderId - the order id from the crm
...
<form action="<?php echo add_query_arg( 'insurance-type', $_GET['insurance-type'], get_permalink( get_field( '_sogo_insurance_compare_2_link', 'option' ) ) ); ?>"
    ...
    <input name="ai" type="hidden" value="<?php echo $ai; ?>"/>
    <input name="ei" type="hidden" value="<?php echo $ei; ?>"/>
    <input name="mandat_p" class="mandat_p" type="hidden" value="<?php echo $order_params['order_details']['mandat_price']; ?>"/>
    <input name="currentOrderId" type="hidden" value="<?php echo $currentOrderId; ?>"/>
    <input name="insurance-date-start" type="hidden" value="<?php echo $order_params['order_details']['insurance-date-start'] ?>"/>
...
פרטי בעל הרכב (יהיה גם בעל הפוליסה)
...
<div class="col-lg-5">
                                ...
                                <label for="license-number"
                                    ...
                                    <?php //var_dump($order_params);die; ?>
                                <input type="text"
                                       data-year="<?php echo $order_params ['order_details']['vehicle-year'] ?>"
                                       id="license-number"
                                       name="license-number" class="w-100"
                                       value="<?php echo $order_params['order_details']['license_no'] ?? ''; ?>"
                                        <?php echo (isset($order_params['order_details']['license_no']) && $order_params['order_details']['license_no'] !== "") ? 'readonly' : '' ; ?>/>

<!--   sami canceled unnecessary fields
                                <label for="compare3-name" class="text-5 color-6 d-inline-block mb-1 w-100">שם מלא</label>
                                <input type="text" id="compare3-name" name="compare3-name" class="w-100" placeholder="שם מלא">

                                <label for="compare3-phone" class="text-5 color-6 d-inline-block mb-1 w-100">טלפון</label>
                                <input type="tel" id="compare3-phone" name="compare3-phone" class="w-100" placeholder="טלפון">
-->
                            ...
                            <div class="s-input-wrapper <?php echo $class; ?> under">
                ...
                <div class="container-fluid mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="text-left compare3-button">
                ...
                <h5 class="mb-0 text-5">
                    <a class="collapsed d-flex align-items-center flex-wrap" data-toggle=""
                       ...
                       aria-expanded="false" aria-controls="collapseThree">
						...
						הנהגים - <?php _e( 'Driver details', 'sogoc' ); ?>
                        ...
                        <div class="row justify-content-between">
                            <div class="col-lg-12 payment-default">
                                <div class="row justify-content-between">
									...
									<?php
                                    $upsales_max_payments = array();
                                    $upsales_prices = array();
                                    $upsales_names = array();
                                    $upsales_sku = array();
                                    if ( have_rows( 'insurance_upsales', 'options' ) ) : ?>
                                        ...
                                        <div class="col-lg-6 upsales-default">
											<?php while ( have_rows( 'insurance_upsales', 'options' ) ): the_row(); ?>
                                                ...
                                                $upsales_max_payments[] = get_sub_field( 'upsales_max_payments_num' );
                                                $upsales_prices[] = get_sub_field( 'upsales_price' );
                                                $upsales_names[] = get_sub_field( 'upsales_product_name' );
                                                $upsales_sku[] = get_sub_field( 'upsale_sku' );
                                                $upsales_fixed_checkbox = (get_sub_field( 'upsales_fixed_checkbox' )) ? ' checked ' : '';
												?>
												...
												<?php if ( get_sub_field( 'insurance_type' ) == $insType ) : ?>
                                                    ...
                                                    <div class="upsales-box form-group mb-2 <?php echo ($upsales_fixed_checkbox) ? 'd-none' : ''?>"
                                                         id="upsales_box_<?php echo $index; ?>"
                                                         data-id="<?php echo $index; ?>">

                                                        <input type="checkbox"
															<?php echo $checked; ?>
                                                            <?php echo $upsales_fixed_checkbox; ?>
                                                        ...
                                                        <label for="upsale_<?php the_sub_field( 'upsale_sku' ); ?>"
                                                               class="d-flex align-items-center checkbox-label text-5 color-6 flex-wrap <?php// echo ($upsales_fixed_checkbox) ? 'upsale-fixed-checkbox' : ''?>">
                ...
                <h5 class="mb-0 text-5 price-tab-title">
                    <a class="collapsed d-flex align-items-center p-card" data-toggle=""
                       ...
                       aria-expanded="false" aria-controls="collapseSix">
                        <i class="icon-check-01-colorwhite icon-x2 ml-1 d-inline-block"></i>
                ...
                <div class="card-block mb-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row justify-content-between">
                            ...
                            <!-- Terms & conditions 1 -->
                            <div class="col-lg-5 payment-default">
...
<!--                                        </div>-->
                                        ...
                                        <?php $upsale_max_payments_num = (int) $order_params['upsales_max_payments_num']; ?>
                                        <?php for ( $i = 0; $i < count($upsales_names); $i ++ ){ ?>
                                            <?php if($upsales_prices[$i] !== '0' && $upsales_prices[$i]){ ?>
                                                <div class="col-lg-10 mb-3 d-none"
                                                     id="upsales_payments_<?php echo($upsales_sku[$i]); ?>">
                                                    <?php
                                                    $current_payments_num = $upsales_max_payments[$i];
                                                    $current_payments_num_array = [];

                                                    for ( $j = 1; $j <= $current_payments_num; $j ++ ) {
                                                        $current_payments_num_array[ $j ] = $j;
                                                    }

                                                    $product_name = $upsales_names[$i];
                                                    $product_id = "upsales_payments_num_". $upsales_sku[$i];
                                                    $order_params['upsales-price'] = $upsales_prices[$i];
                                                    sogo_do_select( $product_name, $product_id, $current_payments_num_array, '', '', 'required', '', '', $help_array );
                                                    ?>
                                                </div>
                                            <?php } ?>
                                        <?php } ?>
                    ...
                    <div class="container-fluid mb-3">
                        ...
                        <div class="row justify-content-between d-none">
                            ...
                            <div class="col-lg-5 mb-3">
                                ...
                                <label class="total_val text-3 color-3">סה"כ לתשלום: <span>555</span></label><hr>
